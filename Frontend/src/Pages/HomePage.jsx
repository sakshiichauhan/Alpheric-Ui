...
const HomePage = () => {
  ...
  return (
    <section
      id="#"
      className="min-h-screen w-full bg-gradient-to-br from-white to-[#F5F0FF]"
    >
            ...
            <div className="space-y-8 mt-14">
              ...
              <div className="flex gap-6 font-urbanist">
                ...
                <div className="flex -space-x-3">
                  <div className="w-9 h-9  border-2 border-white bg-gray-200 shadow-lg">
                    <img src={asset_1} />
                  </div>
                  <div className="w-9 h-9  border-2 border-white bg-gray-200 shadow-lg">
                    <img src={asset_2} />
                ...
                <p className="text-lg text-gray-600 max-w-md">
                  Let's Craft A Digital Strategy Powered By Award-Winning Tech
                  To Drive Real Results And Grow Your Business — Together! 🚀
                </p>                                                                                                                                                                                                                                                                                                                                                                                                      
              </div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 relative h-full flex items-center justify-center">
            ...
            <div className="absolute top-8 left-8">
              <div className="relative w-34 h-34">
                ...
                <svg
                  className="animate-spin-slow absolute inset-1"
                  viewBox="0 0 100 100"
                >
                  <defs>
                    <path
                  ...
                  <text>
                    <textPath href="#circlePath" fontSize="9" startOffset="1">
