...
const Contact = () => {
  ...
  return (
    <section className="min-h-screen w-full flex items-center justify-start px-[116px]">
      ...
      >
        <h3 className="text-[40px] text-[#444444]">Shall we chat?</h3>
        ...
        <div className="flex items-center gap-3 group hover:underline underline-offset-8 decoration-4 transition">
