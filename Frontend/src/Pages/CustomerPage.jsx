...
export default function Customers() {
  ...
  // Fade + slide transforms for the left text
  ...
  return (
    // Moved max-w-7xl & flex layout classes up to the <section>.
    // Also added mx-auto so it remains centered and doesn't exceed max width.
    <section className="relative w-full max-w-7xl mx-auto h-[300vh] flex bg-white">
          ...
          >
            <div>
              ...
              <p className="text-[18px] pl-8 text-gray-500 text-base mt-2">
                Find out what makes you stand apart from others and why certain
                careers are great fits for you.
              </p>
            </div>
          </motion.div>
      ...
      >
        {/** 
          Apply translateX plus originX: 1 to pivot from the right side 
          (makes the leftward movement align with your 'right' positioning).
        */}
        <motion.div
        ...
        >
          ...
          {/* Row 4 */}
          <motion.div
            style={{ position: "absolute", top: 270, right: 180 }}
            className="flex items-center gap-8"
          >
            <motion.div className="w-20 h-20 bg-white rounded-full shadow-sm flex items-center justify-center p-4">
              <img
          ...
          {/* Row 5 */}
          <motion.div
            style={{ position: "absolute", top: 360, right: 240 }}
            className="flex items-center gap-8"
          >
            <motion.div className="w-24 h-24 bg-white rounded-full shadow-sm flex items-center justify-center p-4">
              <img
          ...
          {/* Row 6 (blue) */}
          <motion.div
            style={{ position: "absolute", top: 460, right: 300 }}
            className="flex items-center gap-8"
          >
          ...
          {/* Row 7 (blue) */}
          <motion.div
            style={{ position: "absolute", top: 560, right: 360 }}
            className="flex items-center gap-8"
          >
          ...
          {/* Row 8 (blue) */}
          <motion.div
            style={{ position: "absolute", top: 650, right: 420 }}
            className="flex items-center gap-8"
          >
          ...
          {/* Row 9 (blue) */}
          <motion.div
            style={{ position: "absolute", top: 740, right: 480 }}
            className="flex items-center gap-8"
          >
            <motion.div className="w-20 h-20 bg-[#5AC8DC] rounded-full shadow-sm flex items-center justify-center p-4">
              <img
          ...
          {/* Row 10 (blue) */}
          <motion.div
            style={{ position: "absolute", top: 830, right: 540 }}
            className="flex items-center gap-8"
          >
            <motion.div className="w-24 h-24 bg-[#5AC8DC] rounded-full shadow-sm flex items-center justify-center p-4">
              <img
          ...
          {/* Row 11 (green) */}
          <motion.div
            style={{ position: "absolute", top: 920, right: 600 }}
            className="flex items-center gap-8"
          >
